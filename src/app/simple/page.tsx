    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8 font-mono">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-2">
          {projectsData
            .filter(
              (project) => project.focus === true && project.hide === false
            )
            .map((project, index) => {
              ...
              return (
                <div key={project.title} className="border">
                  <button
                    ...
                    className="w-full p-3 sm:p-4 text-left hover:scale-[1.01] transition-transform"
                  >
                    ...
                    <div className="p-3 sm:p-4 border-t">
                      {project.demoVideo && (
                        <div className="mb-4">
                          ...
                          <div
                            className="relative w-full overflow-hidden rounded-lg border mx-auto"
                            style={{
                              paddingBottom: "56.25%",
                              minHeight: "200px",
                            }}
